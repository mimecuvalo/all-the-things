...
storiesOf('Material UI', module)
  .add('Demos', () => (
    <a href="https://mui.com//demos/app-bar/" target="_blank" rel="noopener noreferrer">
      Material UI demos
    </a>
  ))
  .add('API', () => (
    <a href="https://mui.com//api/app-bar/" target="_blank" rel="noopener noreferrer">
      Material UI API
    </a>
  ))
  .add('Style', () => (
    <a href="https://mui.com//style/icons/" target="_blank" rel="noopener noreferrer">
      Material UI style
    </a>
  ))
  .add('Layout', () => (
    <a href="https://mui.com//layout/basics/" target="_blank" rel="noopener noreferrer">
      Material UI layout
    </a>
  ))
  .add('Utils', () => (
    <a href="https://mui.com//utils/modal/" target="_blank" rel="noopener noreferrer">
      Material UI utils
    </a>
  ));
